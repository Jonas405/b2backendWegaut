        ...
        verifyContactBeforeAdd: function (req, res){
           // console.log(req.body.email);
            ...
            User.findOne({email: req.params.email}, function(err, result) {
               ...
               if(result){
                   console.log("el usuario esta en la plataforma y lo voy a agregar a mis contactos")
                   console.log(result);
                   return result;
               }else{
                console.log("el usuario no esta en la plataforma y no lo puedo agregar a mis contactos")
                return null;
               }
              });
        },
